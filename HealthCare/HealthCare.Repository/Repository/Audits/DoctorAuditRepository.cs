...
{
    public class DoctorAuditRepository : Repository<HealthcareDoctorAudit>, IDoctorAuditRepository
    {
        private readonly IDbContextFactory<HealthCareDbContext> _contextFactory;

        public DoctorAuditRepository(IDbContextFactory<HealthCareDbContext> contextFactory) : base(contextFactory)
        {
